<form action="" method="post">
  <p>
    ...
    <input class="inputTitle" type="text" name="titre" value="<?= isset($chapters) ? $chapters['title'] : '' ?>" placeholder="saissisez ici le titre de votre chapitre"/><br/>
 
    <?= isset($erreurs) && in_array(\Entity\Chapters::CONTENU_INVALIDE, $erreurs) ? 'Le contenu est invalide.<br />' : '' ?>
    <textarea class="mytextarea" rows="8" cols="60" name="contenu"><?= isset($chapters) ? $chapters['content'] : '' ?>
    </textarea><br/>
	<?php
